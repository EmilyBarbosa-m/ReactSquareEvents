      ...
      <div className="App">
        ...
        <header id="topo-home">
          <nav className="menu-home">
            ...
            <ul id="ul-home">
              <li ><a className="home-as" href="#">Home</a></li>
              <li ><a className="home-as" href="#">Login</a></li>
              <li><a className="home-as" href="#">Crie Seu Evento</a></li>
            </ul>
          </nav>
        </header>
        ...
        <section id="categorias_home">
          <div className="categorias_home_boxs">
            ...
            <div className="rightconta-home">
              <img className="imagem_conta_home" src={require("./assets/img/undraw_having_fun_iais.png")} alt="equipe reunida se divertindo e segurando bebidas" />
